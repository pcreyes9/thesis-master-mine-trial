            ...
            <form wire:submit.prevent="StoreBrandData">
                <div class="modal-body grid grid-cols-12 gap-4 gap-y-3">
                    ...
                    <div class="col-span-12">
                        ...
                        <input type="text" id="title" wire:model.lazy="name" wire:offline.class="border-warning"  class="form-control flex-1  @error('name') border-danger @enderror" placeholder="Brand Name" >
