         ...
         <div class="grid grid-cols-12 gap-6">
                ...
                <div class="report-box-2 intro-y mt-5">
                    <div class="box grid grid-cols-12">
                        <div class="col-span-12 lg:col-span-4 px-8 py-12 flex flex-col justify-center">
                            ...
                            <div class="justify-start flex items-center text-slate-600 dark:text-slate-300 mt-12"> My Total Sales <i data-lucide="alert-circle" class="tooltip w-4 h-4 ml-1.5" title="Total value of your sales: $158.409.416"></i> </div>
                            <div class="flex items-center justify-start mt-4">
                                <div class="relative text-2xl font-medium pl-3 ml-0.5"> <span class="absolute text-xl font-medium top-0 left-0 -ml-0.5">₱</span> {{$total_sales}} </div>
                            </div>
            ...
            <div class="col-span-12 md:col-span-6 lg:col-span-4 xl:col-span-3 row-start-4 lg:row-start-3 xl:row-start-auto mt-6 xl:mt-8">
                <div class="intro-y flex items-center h-10">
                    ...
                    <a href="{{Route('report.index')}}" class="ml-auto text-primary truncate">Show More</a>
                </div>
                    ...
                    <table class="table table-report sm:mt-2">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center whitespace-nowrap">Total Sales</th>
                            ...
                            @if ($customer->order_total > 0)
                                <div class="intro-x">
                                    ...
                                    <div class="ml-4 mr-auto">
                                        ...
                                        <div class="text-slate-500 text-xs mt-0.5">Total Orders: {{$customer->order_total}}</div>
                                    </div>
                                    <div class="text-success">{{$customer->total_sales}}</div>
                                </div>
                            @endif
                        @endforeach 
